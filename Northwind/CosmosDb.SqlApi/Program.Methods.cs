...
partial class Program
{
    ...
    private static string account = ""; // use your account
    ...
    */
    ...
    static async Task CreateCosmosResources()
    {
        ...
        catch (HttpRequestException ex)
        {
            ...
            WriteLine(
                "Hint: If you are using the Azure Cosmos Emulator then please make sure it is running."
            );
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            )
            {
                ...
                using (NorthwindContext db = new())
                {
                    ...
                    {
                        WriteLine(
                            "Cannot connect to the SQL Server database to "
        ...
        try
        {
            ...
            )
            {
                ...
                while (resultsIterator.HasMoreResults)
                {
                    ...
                    {
                        WriteLine(
                            "id: {0}, productName: {1}, unitPrice: {2:C}",
                            arg0: product.id,
